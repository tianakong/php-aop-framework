...
//			更多信息界面
	...
	! function() {
		...
		e.siblings(".layui-nav-child")[0] && d.hasClass(C) && (A.sideFlexible("spread"), layer.close(e.data("index"))), A.tabsPage.type = "nav"
